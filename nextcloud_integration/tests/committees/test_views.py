...
class CloudFolderCreateViewTestCase(AssocationGroupTestingMixin, ViewValidityMixin, TestCase):
    ...
    def test_fixed_values(self, mock):
        ...
        self.assertEqual(
            CloudFolderCreateView.template_name,
            "nextcloud_integration/committees/committee_cloud_folder_add.html"
        )
...
class TestFolderMixin(AssocationGroupTestingMixin, ViewValidityMixin):
    ...
    def get_url_kwargs(self, **kwargs):
        return super(TestFolderMixin, self).get_url_kwargs(
...
class CloudFolderEditViewTestCase(TestFolderMixin, TestCase):
    ...
    def test_fixed_values(self):
        ...
        self.assertEqual(
            CloudFolderEditView.template_name,
            "nextcloud_integration/committees/committee_cloud_folder_edit.html"
        )
...
class CloudFileSyncViewTestCase(TestFolderMixin, TestCase):
    ...
    def test_fixed_values(self, mock):
        ...
        self.assertEqual(
            CloudFileSyncView.template_name,
            "nextcloud_integration/committees/committee_cloud_folder_sync.html"
        )
