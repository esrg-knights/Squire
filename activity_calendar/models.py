...
class Activity(models.Model):
    ...
    type = models.CharField(max_length=8, default=ActivityType.ACTIVITY_PUBLIC, choices=[
    ...
    def get_activitymoments_between(self, start_date, end_date, exclude_removed=True):
        ...
        removed_moments_queryset = self.activitymoment_set.filter(status=ActivityStatus.STATUS_REMOVED).values_list('recurrence_id', flat=True)
