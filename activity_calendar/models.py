...
class Activity(models.Model):
    class Meta:
        ...
        permissions = [
            ...
            ('can_ignore_activity_participants_limits',     "[F] Can ignore the participants limit on activities."),
            ('can_ignore_slot_participants_limits',         "[F] Can ignore the participants limit on slots."),
