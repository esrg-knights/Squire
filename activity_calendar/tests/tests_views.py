...
class ActivityAdminTest(TestCase):
    ...
    def test_get_slots_valid_date(self):
        ...
        self.assertEqual(context['recurrence_id'], dateparse.parse_datetime('2020-08-19T14:00:00.000Z'))
        ...
        # Cannot create a slot as subscriptions are closed
        self.assertFalse(context['can_create_slot'])

        self.assertFalse(context['subscriptions_open'])
