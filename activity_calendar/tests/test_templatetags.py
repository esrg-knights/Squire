...
class GetNextActivityInstancesTestCase(TestCase):
    ...
    def test_default_start_dt(self, mock):
        ...
        self.assertEqual(
            instances[0].recurrence_id,
            dateparse.parse_datetime('2020-08-12T14:00:00+00:00')
        )

    def test_start_dt(self):
        instances = get_next_activity_instances(
            self.activity,
            start_dt=dateparse.parse_datetime('2020-08-19T00:00:00+00:00')
        )
        self.assertEqual(
            instances[0].recurrence_id,
            dateparse.parse_datetime('2020-08-19T14:00:00+00:00')
        )

    def test_override_recurrent_from_db(self):
        instances = get_next_activity_instances(
            self.activity,
            start_dt=dateparse.parse_datetime('2020-08-04T00:00:00+00:00')
        )
    ...
    def test_exclude_removed_events(self):
        ...
        self.assertEqual(
            instances[0].recurrence_id,
            removed_moment.recurrence_id + timedelta(days=7)
        )
