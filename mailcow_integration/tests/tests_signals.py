...
class MemberAliasSignalsTests(AliasSignalsTestsBase):
    ...
    def test_create_member(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        Member.objects.create(first_name='Foo', last_name="", legal_name="Foo", email="foo@example.com", is_deregistered=True)
...
class CommitteeAliasSignalsTests(AliasSignalsTestsBase):
    ...
    def test_update_committee(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        group = AssociationGroup.objects.create(name="group", contact_email="foo@example.com", type=AssociationGroup.COMMITTEE)
    ...
    def test_delete_committee(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        # Delete board
        group = AssociationGroup.objects.create(name="group", contact_email="foo@example.com", type=AssociationGroup.BOARD)
        self.reset(mock_o, mock_c, mock_gc)
        group.delete()
        mock_c.assert_not_called()
        mock_gc.assert_not_called()
...
class CommitteeMembershipAliasSignalsTests(AliasSignalsTestsBase):
    ...
    def test_create_committee_membership(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        c_group = AssociationGroup.objects.create(name="group", contact_email="foo@example.com", type=AssociationGroup.COMMITTEE)
        b_group = AssociationGroup.objects.create(name="group2", contact_email="bar@example.com", type=AssociationGroup.BOARD)
    ...
    def test_update_committee_membership(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        group = AssociationGroup.objects.create(name="group", contact_email="foo@example.com", type=AssociationGroup.COMMITTEE)
        group2 = AssociationGroup.objects.create(name="group2", contact_email="bar@example.com", type=AssociationGroup.COMMITTEE)
...
class MembershipAliasSignalsTests(AliasSignalsTestsBase):
    ...
    def test_create_membership(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        member_active = Member.objects.create(first_name='Foo', last_name="", legal_name="Foo", email="member@example.com")
        member = Member.objects.create(first_name='Foo', last_name="", legal_name="Foo", email="bar@example.com", is_deregistered=True)
        self.reset(mock_c, mock_m)
    ...
    def test_delete_membership(self, _, mock_o: Mock, mock_c: Mock, mock_gc: Mock, mock_m: Mock):
        ...
        member_inactive = Member.objects.create(first_name='Foo', last_name="", legal_name="Foo", email="b@example.com", is_deregistered=True)
