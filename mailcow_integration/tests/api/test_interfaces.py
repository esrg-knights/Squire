...
from mailcow_integration.api.interface.mailbox import MailboxStatus, MailcowMailbox, QuarantaineNotificationCategory, QuarantineNotification
...
class MailcowInterfacesTest(TestCase):
    ...
    def test_rspamd_from_json(self):
        ...
        setting = RspamdSettings.from_json({
            "id": 1,
