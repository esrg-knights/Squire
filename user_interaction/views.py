...
welcome_messages = [
    ...
    "Fun fact: The Ivoren Wachters' favourite swordfighting-move is the shield bash!",
    ...
    "Fun fact: The TCG committee's favourite card game is Uno!",
    "Fun fact: The Inn-Drinkers' favourite drink is Fristi-cola!",
    "Fun fact: The bartenders' favourite bar is |",
    "Fun fact: The crafting committee's favourite fabric is the space-time fabric!",
    "Fun fact: The storytellers' committee's favourite story is about the 2e kamer!",
    "Fun fact: The promotion committee's favourite merch are the Knights oven mittens!",
    "Fun fact: The intro committee's favourite intro is the Fontys intro!",
    "Fun fact: The yearbook committee's favourite book is the dictionary!",
    "Fun fact: The KCC's favourite receipt is the one that's missing!",
    "Fun fact: The weekend committee's favourite location is Hoeve Ostade!",
    "https://www.youtube.com/watch?v=1iQzFLO8xeE",
    "The Knights have their own alumni association: The Lords of the Kitchen Table. If you're old, message the board!",
    "Bugs reported so far: -2,147,483,648",
]
