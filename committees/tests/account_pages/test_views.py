...
class AssociationGroupAccountTestCase(TestCase):
    ...
    def test_class(self):
        ...
        self.assertEqual(AssociationGroupAccountView.template_name, "committees/account_pages/account_group_overview.html")
        self.assertEqual(AssociationGroupAccountView.permission_required, 'membership_file.can_view_membership_information_self')
